...
public class TimeWindow extends Window {
	...
	public TimeWindow cover(TimeWindow other) {
		return new TimeWindow(Math.min(start, other.start), // 开始时间比较小的
							  Math.max(end, other.end) // 结束时间比较大的
		);
	}
	...
	public static long getWindowStartWithOffset(long timestamp, long offset, long windowSize) {
		 ...
		 * offset = 0
		 * windowSize = 14000
		 * 上述的输出表明，当窗口长度为14秒的时候，对于元素 1000000109000 所属的窗口就是
		 * [1000000106000,1000000120000)
		 */
