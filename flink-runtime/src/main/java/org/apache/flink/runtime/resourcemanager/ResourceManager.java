...
public abstract class ResourceManager<WorkerType extends ResourceIDRetrievable>
	...
	/**
	 *  Task Executor 启动后，会像 resource manager 注册一下自己
	 *  调用的就是这个方法
	 */
	@Override
	...
	public CompletableFuture<Acknowledge> sendSlotReport(ResourceID taskManagerResourceId,
														 ...
														 SlotReport slotReport, // 来自taskmanager的slot信息
														 Time timeout) {
	 ...
	 * 当前 resourceManager 被选举为 leader时候，回调的方法
	 * @param newLeaderSessionID unique leadershipID  每次选举都会产生一个唯一的UUID
	 */
	@Override
