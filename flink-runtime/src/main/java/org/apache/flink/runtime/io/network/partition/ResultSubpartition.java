 ...
 *
 * 一个 ResultPartition 是由多个 ResultSubpartition 组成.
 *
 * 当 Producer Operator 实例生产的数据要发送给下游 Consumer Operator 的 N 个实例时.
 * 那么该 Producer Operator 实例对应的 ResultPartition 中就包含 N 个 ResultSubpartition.
 *
 */
