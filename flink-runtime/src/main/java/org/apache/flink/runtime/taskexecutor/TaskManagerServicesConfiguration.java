...
public class TaskManagerServicesConfiguration {
	...
	public TaskManagerServicesConfiguration(
			...
			int numberOfSlots,// taskmanager.numberOfTaskSlots
			int pageSize,
	...
	public static TaskManagerServicesConfiguration fromConfiguration(
		...
		return new TaskManagerServicesConfiguration(
			...
			ConfigurationParserUtils.getSlot(configuration),  // taskmanager.numberOfTaskSlots
			ConfigurationParserUtils.getPageSize(configuration),// 内存 segment的大小，默认是32KB
